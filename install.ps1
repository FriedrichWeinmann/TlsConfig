<#
	.SYNOPSIS
		Installs the TlsConfig Module from github
		
	.DESCRIPTION
		This script installs the TlsConfig Module from github.
...
$ModuleName = "TlsConfig"

# Base path to the github repository
$BaseUrl = "https://github.com/FriedrichWeinmann/TlsConfig"
